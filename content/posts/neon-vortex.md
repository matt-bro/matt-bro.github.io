...
> it should be controlled by keyboard keys and mouse<br>
> visual effects and the gravity bending should be in there<br>
> we need to have some geometry wars style background music

This is the result.
<figure>
  <a href="/games/neon-vortex.html" target="_blank" rel="noopener"><img src="/images/neon-vortex.jpg" alt="Neon Vortex gameplay: a wireframe grid torn into radial streaks around a black hole, pink enemies scattered across the arena, score 11,560" width="1600" height="809"></a>
